...
def synthesize_podcast(text: str, voice: str = "en-US-JennyNeural", 
    ...
    try:
        ...
        # Configure for podcast quality
        speech_config.speech_synthesis_speaking_rate = 0.9  # Slightly slower for clarity
        speech_config.speech_synthesis_pitch = 0  # Normal pitch
...
def generate_podcast_with_transcript(selected_text: str, related: list, insights: str, 
    ...
    try:
        ...
        return {
            ...
            "created_at": str(uuid.uuid4().hex)  # Simple timestamp
        }
